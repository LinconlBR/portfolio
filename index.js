// Always start at top of page on reload
        ...
        */ 
        ...
        let index = 0;
        const speed = 50; // milissegundos
         
        setTimeout(()=>{ text.forEach((line, lineIndex) => {
            setTimeout(() => {
                let charIndex = 0;
                const lineElement = document.getElementById(`linha${lineIndex + 1}`);
            ...
            }, lineIndex * 1000); // Delay between lines
        });}, 2000);
